...
```cpp
--8<-- "exercises/templatelab/session.h:listing"
```
...
```cpp
--8<-- "exercises/templatelab/policies.h:listing"
```
...
```cpp
--8<-- "exercises/templatelab/main.cpp:nothrow-move-assert"
```
...
```cpp
--8<-- "exercises/templatelab/util.h:listing"
```
