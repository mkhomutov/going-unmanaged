...
Real questions do not arrive at the chapter that answers them; they arrive mid-task, at a desk, with no one to ask. This page is the index of the ones that were asked that way, each restated as you would search for it and each pointing at where the book answers it — a section of the chapter that owns the concept, a recipe in [Appendix F](F-rosetta-cookbook.md#appendix-f--the-rosetta-cookbook), or a finding in [Chapter 25](25-findings-from-practice.md#chapter-25--gotchas-the-findings-log). The answer lives there, integrated with what the chapter already teaches; this page is only the way in, the way the [Symptom Index](symptoms.md#symptom-index) is the way in from what is on the screen.
