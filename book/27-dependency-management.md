...
This is the normal case for the SDK your product is built on, and it is the one dependency you do not get to choose or version — see below. For a library the system itself ships — no config package, but a module CMake carries or a `.pc` file — the spelling is [Appendix J](J-cmake-catalogue.md#appendix-j--the-cmake-catalogue)'s.
