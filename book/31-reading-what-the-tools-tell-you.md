...
| The host dies on entry to some function when a pasted formula is long enough — no report shape, no frame of yours | [Chapter 42](42-the-formula-field.md#chapter-42--the-formula-field): a recursion the user's text sizes; bound the depth and refuse with a position |
