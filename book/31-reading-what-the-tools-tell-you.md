...
| A file watcher fires once and then never again — or fires for a save that changed nothing it can see | Recipe 40 in [Appendix F](F-rosetta-cookbook.md#appendix-f--the-rosetta-cookbook): an editor saved by rename (Recipe 38), or a timestamp at the filesystem's resolution |
