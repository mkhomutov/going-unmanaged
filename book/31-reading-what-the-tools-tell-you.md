...
The table that routes the book from what is on the screen to the page that owns it is its own page: [Symptom Index](symptoms.md#symptom-index). Every report shape above has a row there.
