...
- "A per-configuration decision is a generator expression, not an if on CMAKE_BUILD_TYPE — under a multi-config generator the variable is empty and the if is silently false."
