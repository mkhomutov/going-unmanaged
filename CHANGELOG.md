...
- **New: Recipe 42 — open a local database and run a query** (MINOR — an
  ...
  the same question asked of the caller's pointer. `exercises/cookbook/
  database.cpp` is the fourth translation unit behind a probe — sqlite3
  ...
  `FakeSdk_LiveAllocations` did in Chapter 17. Chapters 16, 27 and 33 point
